...
//
//        ApiResponse<Map<String, String>> serviceResponse = ApiResponse.success(
//                Map.of("message", "OTP sent to your email. Please verify.", "userId", "user123")
//        );
//        when(authService.registerUser(any(UserRequestDTO.class), anyString())).thenReturn(serviceResponse);
//
//        ResponseEntity<ApiResponse<Map<String, String>>> response = authController.registerUser(userRequestDTO, request);
//
//        assertEquals(HttpStatus.CREATED, response.getStatusCode());
//        assertEquals("OTP sent to your email. Please verify.", response.getBody().getData().get("message"));
//        assertEquals("user123", response.getBody().getData().get("userId"));
...
//
//        ApiResponse<Map<String, String>> serviceResponse = ApiResponse.error(
...
//        assertEquals("Either email or phone number must be provided", response.getBody().getMessage());
//        verify(authService, times(1)).registerUser(any(UserRequestDTO.class), eq("127.0.0.1"));
//    }
//
//    /**
...
//        assertEquals("Too many registration attempts. Please try again later.", response.getBody().getMessage());
//        verify(authService, times(1)).registerUser(any(UserRequestDTO.class), eq("127.0.0.1"));
//    }
//
//    /**
...
//
//        ApiResponse<Map<String, String>> serviceResponse = ApiResponse.success(
//                Map.of("message", "OTP resent to your email", "userId", "user123")
//        );
//        when(authService.registerUser(any(UserRequestDTO.class), anyString())).thenReturn(serviceResponse);
//
//        ResponseEntity<ApiResponse<Map<String, String>>> response = authController.registerUser(userRequestDTO, request);
...
//        assertEquals("OTP resent to your email", response.getBody().getData().get("message"));
//        assertEquals("user123", response.getBody().getData().get("userId"));
//        verify(authService, times(1)).registerUser(any(UserRequestDTO.class), eq("127.0.0.1"));
//    }
//
